...
const ANSWERS = [];
ANSWERS['Q_CHECKOUT_TIME'] =  {text: 'Checkout time for VENUE_NAME is VALUE', parameters: ['VENUE_NAME', 'VALUE'], api_name:'service-time', type: 'Venue', value:'startTime'};
ANSWERS['Q_CHECKIN_TIME']  =  {text: 'Checkin time for VENUE_NAME is VALUE', parameters: ['VENUE_NAME', 'VALUE'], api_name:'service-time', type: 'Venue', value:'endTime'};
ANSWERS['Q_LASTCALL_TIME'] =  {text: 'Lastcall time for VENUE_NAME is VALUE', parameters: ['VENUE_NAME', 'VALUE'], api_name:'service-time', type: 'Venue', value:'lastCallTime'}; 
ANSWERS['Q_RESTAURANT_OPEN'] = {text: 'VENUE_NAME opens at VALUE', parameters: ['VENUE_NAME', 'VALUE'], api_name:'service-time', type: 'Restaurtant', value:'startTime'}; 
ANSWERS['Q_RESTAURANT_CLOSE'] = {text: 'VENUE_NAME closes at VALUE', parameters: ['VENUE_NAME', 'VALUE'], api_name:'service-time', type: 'Restaurtant', value:'endTime'}; 
ANSWERS['Q_OPEN_TIME'] = {text: 'VENUE_NAME opens at VALUE', parameters: ['VENUE_NAME', 'VALUE'], api_name:'service-time', type: 'Venue', value:'startTime'};
ANSWERS['Q_CLOSE_TIME'] = {text: 'VENUE_NAME closes at VALUE', parameters: ['VENUE_NAME', 'VALUE'], api_name:'service-time', type: 'Venue', value:'endTime'};
ANSWERS['Q_WIFI'] = {text: 'VALUE', api_name:'info', value:'wifi'};
ANSWERS['Q_GYM'] =  {text: 'VALUE', api_name:'info', value:'gym'};
...
function fetchDataAndSendReply(user, answer, venueName, channel) {
  ...
  } else if (answer.api_name === 'info'){
    // generally info should be availabe with the venue so read from venue and set as info
...
function sendAnswer(user, answer, venueName, channel) {
  ...
  if (typeof(data) !== 'undefined' && answer.api_name === 'info') {
    for (var i = 0; i < data.length; i++) {
      if (data[i].name === answer.value){
        channel.sendMessage(user.id, formatText(answer, venueName, data[i].value));
        return;
      }
    }
